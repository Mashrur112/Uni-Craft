           ...
           GestureDetector(
             ...
             child: Center(
               child: Container(
                 ...
                 child: Center(child: Text("Upload file",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)),
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                 ...
                 // print(widget.role);
                  ...
                  if (snapshot.hasData ) {
                    ...
                    profile_info.insert(0, snapshot.data!.docs[c-1]['imageLink']);
                        ...
                        children: [
                          Stack(children: [
                            ...
                            Positioned(
                                ...
                                child: Text(
                                    profile_info[5],style: TextStyle(fontWeight: FontWeight.bold,color: Colors.cyanAccent,fontSize: 20),),),
                            Positioned(
                            ...
                            Positioned(
                              ...
                              child:
                                    ...
                                    Text("Age: " +profile_info[2],style: TextStyle(color: Colors.grey,fontSize: 18),),
                            ...
                            Positioned(
                              ...
                              Text("Joining code: " +profile_info[6],style: TextStyle(color: Colors.grey,fontSize: 16),),
                            ...
                            Positioned(
                              ...
                              left: (16 / 392) * screenW,
                                    ...
                                    child: Text( profile_info[4],style: TextStyle(color: Colors.grey,fontSize: 15,fontWeight: FontWeight.bold)),
