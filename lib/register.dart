    ...
    showDialog(context: context,
        builder:(context){
          return  AlertDialog(
            ...
            title:  Text("Password don't match",style: TextStyle(color: Colors.white),),
         ...
         child: Column(
           ...
           children: [
             ...
             Padding(
               ...
               child: Image.asset("assets/images/logo.png",height: (200/872.72)*screenH,width: (200/392.72)*screenW,),
             ),
             ...
             Center(
               child: Container(
                 ...
                 margin:  EdgeInsets.fromLTRB(0, ((120/872.72)*screenH), 0, 0),
               ...
               child: Container(
                 ...
                 child: TextField(
                   ...
                   decoration: InputDecoration(
                     ...
                     suffixIcon: Padding(
                       padding:   EdgeInsets.fromLTRB(0, (4/872.72)*screenH, (11/392.72)*screenW, (4/872.72)*screenH),
                       child: IconButton(
                           onPressed: () {
                             setState(() {
                               if (is_obs)
             ...
             GestureDetector(
               ...
               child: Container(
                 ...
                 padding:  EdgeInsets.fromLTRB((32/392.72)*screenW, (12/872.72)*screenH, (32/392.72)*screenW, (12/872.72)*screenH),
                 decoration: BoxDecoration(
                   color: Colors.blue,
             ...
             //for gap
             Container(height: (40/872.72)*screenH,),
             //or continue with
             ...
             Row(
               ...
               children: [
                 GestureDetector(
                     ...
                     child: Image.asset("assets/images/google.png",height: (80/872.72)*screenH,width: (80/392.72)*screenW,)),
                 SizedBox(width: (0/392.72)*screenW,),
             ...
             Row(
               mainAxisAlignment: MainAxisAlignment.center,
               children: [
                 const Text("Already have a Account?",style: TextStyle(color: Colors.white70),),
                 GestureDetector(
                     onTap: login,


                     child: const Text("login Now",style: TextStyle(color: Colors.blue,fontSize: 14),))
               ],
             ),
